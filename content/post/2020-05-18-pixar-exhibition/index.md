...
{{< image src="pixar-exhibition-intro.jpg" alt="Pixar Exhibition" width="1600" height="1200" >}}
...
{{< image src="pixar-exhibition-production-pipeline.jpg" alt="Production Pipeline panel" width="1200" height="1600" >}}
...
{{< image src="pixar-exhibition-story-and-art.jpg" alt="Story and art panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="A storyboard drawing (*Inside Out*)" >}}
    {{% caption-image src="pixar-exhibition-story-and-art-storyboard-inside-out.jpg" alt="A storyboard drawing (Inside Out)" width="1024" height="1024" %}}
{{< /caption-figure >}}
...
{{< caption-figure caption="Concept art for *Toy Story 3* and *Brave*" >}}
    {{% caption-image src="pixar-exhibition-story-and-art-concept-art-toy-story-3.jpg" alt="Toy Story 3 concept art" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-story-and-art-concept-art-brave.jpg" alt="Brave concept art" width="1024" height="1024" %}}
{{< /caption-figure >}}
...
{{< caption-figure caption="Reproductions of clay sculptures (Joy & Anger from *Inside Out*)" >}}
    {{% caption-image src="pixar-exhibition-story-and-art-sculptures-joy.jpg" alt="Clay sculpture reproduction (Joy from Inside Out)" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-story-and-art-sculptures-anger.jpg" alt="Clay sculpture reproduction (Anger from Inside Out)" width="1024" height="1024" %}}
{{< /caption-figure >}}

{{< caption-figure caption="Resin casts (Remy from *Ratatouille* & Heimlich from *A Bug's Life*)" >}}
    {{% caption-image src="pixar-exhibition-story-and-art-sculptures-resin-casts-ratatouille-remy.jpg" alt="Resin casts (Remy form Ratatouille)" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-story-and-art-sculptures-resin-a-bug-s-life-heimlich.jpg" alt="Resin casts (Heimlich from A Bug's Life)" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Modeling

{{< image src="pixar-exhibition-modeling.jpg" alt="alt Modeling panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Lotso from sculpture to 3D model" >}}
    {{% caption-image src="pixar-exhibition-story-and-art-sculptures-lotso.jpg" alt="Lotso from sculpture to 3D model" width="1024" height="1024" %}}
{{< /caption-figure >}}

{{< caption-figure caption="Modeling interactive exhibit" >}}
    {{% caption-image src="pixar-exhibition-modeling-interactive-exhibit.jpg" alt="Modeling interactive exhibit" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Rigging

{{< image src="pixar-exhibition-rigging.jpg" alt="Rigging panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Demonstration of how a rig is used to animate a character model" >}}
    {{% caption-image src="pixar-exhibition-rigging-sulley-rig-1.jpg" alt="Sulley rig 1" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-rigging-sulley-rig-2.jpg" alt="Sulley rig 2" width="1024" height="1024" %}}
{{< /caption-figure >}}

{{< caption-figure caption="Interactive exhibit demonstrating how a face rig works" >}}
    {{% caption-image src="pixar-exhibition-rigging-jessie-face-rig.jpg" alt="Jessie face rig" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Surfaces

{{< image src="pixar-exhibition-surfaces.jpg" alt="Surfaces panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Changing an object’s surface shader" >}}
    {{% caption-image src="pixar-exhibition-surfaces-materials-interactive-exhibit.jpg" alt="Materials interactive exhibit" width="1024" height="1024" %}}
{{< /caption-figure >}}

{{< caption-figure caption="Demonstration of how textures work using cloth" >}}
    {{% caption-image src="pixar-exhibition-surfaces-materials-texture-mapping-1.jpg" alt="Texture mapping example 1" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-surfaces-materials-texture-mapping-2.jpg" alt="Texture mapping example 2" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Set & Camera

{{< image src="pixar-exhibition-sets-and-cameras.jpg" alt="Set and camera panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Designing a virtual set" >}}
    {{% caption-image src="pixar-exhibition-set-camera-virtual-set.jpg" alt="Virtual set interactive exhibit" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Animation

{{< image src="pixar-exhibition-animation.jpg" alt="Animation panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Creating a simple stop motion animation with Luxo, Jr." >}}
    {{% caption-image src="pixar-exhibition-animation-stop-motion-luxo-jr.jpg" alt="Animation stop motion interactive exhibit Luxo, Jr." width="1024" height="1024" %}}
{{< /caption-figure >}}

## Simulation

{{< image src="pixar-exhibition-simulation.jpg" alt="Simulation panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Simulating grass and a school of fish" >}}
    {{% caption-image src="pixar-exhibition-simulation-grass.jpg" alt="Simulation of grass" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-simulation-school-of-fish.jpg" alt="Simulation of a school of fish" width="1024" height="1024" %}}
{{< /caption-figure >}}
...
{{< caption-figure caption="Simulating Merida’s curly hair turned out to be a challenge for Pixar. They ended up modeling the simulation after coil springs." >}}
    {{% caption-image src="pixar-exhibition-simulation-merida-hair-1.jpg" alt="Merida hair simulation 1" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-simulation-merida-hair-2.jpg" alt="Merida hair simulation 2" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Lighting

{{< image src="pixar-exhibition-lighting.jpg" alt="Lighting panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="Interactive exhibit explaining how computers render realistic lighting" >}}
    {{% caption-image src="pixar-exhibition-lighting-computer-1.jpg" alt="Interactive exhibit explaining how computers render realistic lighting 1" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-lighting-computer-2.jpg" alt="Interactive exhibit explaining how computers render realistic lighting 2" width="1024" height="1024" %}}
{{< /caption-figure >}}

{{< caption-figure caption="Dory from *Finding Nemo* as seen under different lighting conditions" >}}
    {{% caption-image src="pixar-exhibition-lighting-dory-1.jpg" alt="Dory from Finding Nemo as seen under different lighting conditions (blue)" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-lighting-dory-2.jpg" alt="Dory from Finding Nemo as seen under different lighting conditions (red)" width="1024" height="1024" %}}
{{< /caption-figure >}}

## Rendering

{{< image src="pixar-exhibition-rendering.jpg" alt="Rendering panel" width="1200" height="1600" >}}
...
{{< caption-figure caption="From wireframe to rendered image" >}}
    {{% caption-image src="pixar-exhibition-rendering-1.jpg" alt="Wireframe" width="1024" height="1024" %}}
    {{% caption-image src="pixar-exhibition-rendering-2.jpg" alt="Rendered image" width="1024" height="1024" %}}
{{< /caption-figure >}}
